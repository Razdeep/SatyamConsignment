...
//        dd_date_col_2.setCellValueFactory(new PropertyValueFactory("ddDate"));
    ...
    private void saveData(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure that you want save " + voucher_no_field_2.getText() + " ?", ButtonType.YES, ButtonType.NO, ButtonType.CANCEL);
        alert.showAndWait();

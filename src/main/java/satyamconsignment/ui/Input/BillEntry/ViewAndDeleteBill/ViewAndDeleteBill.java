...
public class ViewAndDeleteBill implements Initializable {
	...
	private void getDetails(ActionEvent event) {
		try {
			...
			while (lrPmResultSet.next()) {
				list.add(new LR(lrPmResultSet.getString("Bill No."), lrPmResultSet.getString("LR No."),
	...
	private void deleteEntry(ActionEvent event) {
		Alert alert = new Alert(Alert.AlertType.CONFIRMATION,
				"Are you sure that you want delete " + bill_no_field.getText() + " ?", ButtonType.YES, ButtonType.NO,
				ButtonType.CANCEL);
		alert.showAndWait();

...
public class AddCollection implements Initializable {
	...
	private void addCollection(ActionEvent event) {
		...
		collectionItemObservableList
				.add(new CollectionItem(bill_no_combo.getValue(), bill_date.getText(), bill_amount.getText(),
						supplier_name.getText(), collection_due_field.getText(), amount_collected_field.getText(),
	...
	private void updateCollectionDue() {
		collection_due_field
				.setText(Integer.toString(previouslyDue - Integer.parseInt(amount_collected_field.getText())));
	}
	...
	private void replaceCollection(ActionEvent event) {
		...
		collectionItemObservableList.set(collection_tableview.getSelectionModel().getSelectedIndex(),
				CollectionItem.builder().billNo(bill_no_combo.getValue()).billDate(bill_date.getText())
						.billAmount(bill_amount.getText()).supplierName(supplier_name.getText())
						.due(collection_due_field.getText()).amountCollected(amount_collected_field.getText())
	...
	private void saveData(ActionEvent event) {
		Alert alert = new Alert(Alert.AlertType.CONFIRMATION,
				"Are you sure that you want save " + voucher_no_field.getText() + " ?", ButtonType.YES, ButtonType.NO,
				ButtonType.CANCEL);
		alert.showAndWait();
